...
export default function Admin(props) {
    ...
    const handleChangeMeal = (event) => {
        ...
        props.onMealIdChange(event.target.value)
    };
                        ...
                        <List>
                            ...
                            <ListItem>
                                <FormControl className={classes.formControl}>
                                    ...
                                    <FormHelperText>Please select the meal you want to delete</FormHelperText>
                                </FormControl>
                            </ListItem>
                            <ListItem>
                                <Button onClick={() => props.onMealDeleteButtonClick()} variant="contained"
