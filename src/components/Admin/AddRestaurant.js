                        ...
                        <List>
                            <ListItem>
                                <TextField
                                    ...
                                    label="Name"
                                    required
                                    helperText="Please type the restaurant name"
                                />
                                <Button onClick={() => props.onRestaurantAddButtonClick()} variant="contained" color="primary" className={classes.button}>
                                    Add Restaurant
                                </Button>
                            </ListItem>
                            <ListItem>
                                <TextField
                                    ...
                                    label="Location"
                                    required
                                    helperText="Please type the restaurant location"
                                />
                            </ListItem>
                        </List>
