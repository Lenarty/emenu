...
export default function Admin(props) {
    ...
    console.log(props.items.meal_id)
                    ...
                    <Paper className={classes.paper}>
                        <List>
                            <ListItem>
                                ...
                                <Button onClick={() => props.onMealUpdateButtonClick()} variant="contained" color="primary" className={classes.button}>
                                    Update meal
                                </Button>
                            </ListItem>
                            <ListItem>
                                <FormControl className={classes.formControl}>
                                    <InputLabel id="demo-simple-select-helper-label">Meal Name</InputLabel>
                                    <Select
                                        labelId="demo-simple-select-helper-label"
                                        id="demo-simple-select-helper"
                                        value={meal}
                                    ...
                                    <FormHelperText>Please select the meal you want to update</FormHelperText>
                                </FormControl>
                            </ListItem>
                            <ListItem>
                                {props.items.meals.map(item => (
                                    item.name == meal ? (
                                        <TextField
                                            ...
                                            label={item.name}
                                            id={props.items.meal_id = item.id}
                                            required
                                            helperText="Update meal name"
                                        />
                                    ):null))
                                }
                            </ListItem>
                                ...
                                {props.items.meals.map(item => (
                                    item.name == meal ? (
                                        <TextField
                                            ...
                                            required
                                            helperText="Update meal preparation time"
                                        />
                                    ):null))
                                }
                            </ListItem>
