                        ...
                        <List>
                            <ListItem>
                                <FormControl className={classes.formControl}>
                                    ...
                                    <FormHelperText>Please select the restaurant you want to delete</FormHelperText>
                                </FormControl>
                                <Button onClick={() => props.onRestaurantDeleteButtonClick()} variant="contained" color="primary" className={classes.button}>
                                    Delete Restaurant
                                </Button>
                            </ListItem>
                        </List>
